{ config, lib, pkgs, ... }@args: {
	...
	nixpkgs.overlays = [ (import ./lib/kernel.nix args).linuxKernel_6_19_10_hardenedOverlay ];
	...
	boot.kernelPackages = pkgs.hardenedLinuxPackagesFor pkgs.linuxKernel.kernels.linux_6_19 (old: {
