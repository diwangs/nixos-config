{ config, lib, pkgs, ... }@args: {
	...
	nixpkgs.overlays = [ (import ./lib/kernel.nix args).linuxKernel_7_0_11_hardenedOverlay ];
	...
	boot.kernelPackages = pkgs.hardenedLinuxPackagesFor pkgs.linuxKernel.kernels.linux_7_0 (old: {
